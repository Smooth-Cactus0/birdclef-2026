# %%
# ============================================================================
# BirdCLEF 2026 -- nb15b: Perch Per-Class Logit Feature + Alpha-Blend OFF
# ============================================================================
...
#   -> NO alpha-blend: MLP output is final prediction (BLEND OFF)
#
# Ablation OFF: zero the per-class logit scalar -> approximates nb14c baseline.
...
auc_df.to_csv(OUT_DIR / "per_class_auc_nb15b.csv", index=False)
...
diagnostics = {
    "notebook": "nb15b", "model": "per-class-logit-blend-off",
    "blend": False, "logit_mode": "per_class",
...
with open(OUT_DIR / "diagnostics_nb15b.json", "w") as f:
    json.dump(diagnostics, f, indent=2)
print("Saved diagnostics_nb15b.json")
...
fig.suptitle("nb15b per-class-logit (blend ON): Prediction Distributions", fontsize=11)
...
plt.tight_layout()
plt.savefig(OUT_DIR / "pred_dist_nb15b.png", dpi=100, bbox_inches="tight")
plt.close(); print("Saved pred_dist_nb15b.png")
