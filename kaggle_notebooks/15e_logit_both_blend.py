# %%
# ============================================================================
# BirdCLEF 2026 -- nb15e: Per-Class Logit + Global Logit Ctx + Alpha-Blend ON
# ============================================================================
...
auc_df.to_csv(OUT_DIR / "per_class_auc_nb15e.csv", index=False)
...
diagnostics = {
    "notebook": "nb15e", "model": "both-logit-blend-on",
    "blend": True, "logit_mode": "both",
...
with open(OUT_DIR / "diagnostics_nb15e.json", "w") as f:
    json.dump(diagnostics, f, indent=2)
print("Saved diagnostics_nb15e.json")
...
fig.suptitle("nb15e both-logit (blend ON): Prediction Distributions", fontsize=11)
...
plt.tight_layout()
plt.savefig(OUT_DIR / "pred_dist_nb15e.png", dpi=100, bbox_inches="tight")
plt.close(); print("Saved pred_dist_nb15e.png")
