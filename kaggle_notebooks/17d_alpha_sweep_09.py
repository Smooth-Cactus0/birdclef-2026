...
auc_df.to_csv(OUT_DIR / "per_class_auc_nb17d.csv", index=False)
...
diagnostics = {
    "notebook": "nb17d", "model": "alpha-sweep-09",
    "blend": True, "logit_mode": "per_class", "alpha": 0.9,
...
with open(OUT_DIR / "diagnostics_nb17d.json", "w") as f:
    json.dump(diagnostics, f, indent=2)
print("Saved diagnostics_nb17d.json")
...
fig.suptitle("nb17d alpha-sweep 0.9: Prediction Distributions", fontsize=11)
...
plt.tight_layout()
plt.savefig(OUT_DIR / "pred_dist_nb17d.png", dpi=100, bbox_inches="tight")
plt.close(); print("Saved pred_dist_nb17d.png")
