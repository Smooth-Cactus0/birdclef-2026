...
diagnostics = {
    "notebook": "nb17a", "model": "alpha-sweep-05",
    "blend": True, "logit_mode": "per_class", "alpha": 0.5,
...
print("Saved diagnostics_nb17a.json")
...
fig.suptitle("nb17a alpha-sweep 0.5: Prediction Distributions", fontsize=11)
...
plt.tight_layout()
plt.savefig(OUT_DIR / "pred_dist_nb17a.png", dpi=100, bbox_inches="tight")
plt.close(); print("Saved pred_dist_nb17a.png")
