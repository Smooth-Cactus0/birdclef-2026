# %%
# ============================================================================
# BirdCLEF 2026 -- nb23 NS round 2 TRAINER  (single fold 1)  # 
#                                            generated by _gen_nb23_folds.py)
# ============================================================================
# Noisy Student round 2 on top of NS R1 (LB 0.930). Same recipe as R1 except:
#   * PL signal comes from NS R1 checkpoints (5-fold ensemble, OOF mean 0.9745)
#     instead of supervised checkpoints -- better teachers => cleaner PL.
#   * PL trim relaxed 0.1 -> 0.05 in the R2 saver (recovers soft-positive
#     signal R1 discarded; 2025 1st place reported softer trims across rounds).
#   * NS_POWER_K bumped 1.0 -> 1.5 -- sharpens confidence weighting (1st place
#     ramped power_k each round to compensate for noisier student-teacher gap).
#   * Everything else identical: EPOCHS=25, NS_MIX_RATIO=1.0, drop_path=0.15,
#     SEED=42, same backbone, fresh ImageNet init.
#
# Inputs (dataset_sources): alexycactus/birdclef-2026-cnn-pl-preds-r2
...
NS_ENABLED       = True
NS_POWER_K       = 1.5        # nb23 round 2: ramped from R1's 1.0 (1st place 2025 ramp pattern)
