# %%
# ============================================================================
# BirdCLEF 2026 -- nb15d: Perch Global Logit Context (PCA-32) + Alpha-Blend OFF
# ============================================================================
...
auc_df.to_csv(OUT_DIR / "per_class_auc_nb15d.csv", index=False)
...
diagnostics = {
    "notebook": "nb15d", "model": "global-logit-ctx-blend-off",
    "blend": False, "logit_mode": "global",
...
with open(OUT_DIR / "diagnostics_nb15d.json", "w") as f:
    json.dump(diagnostics, f, indent=2)
print("Saved diagnostics_nb15d.json")
...
fig.suptitle("nb15d global-logit-ctx (blend OFF): Prediction Distributions", fontsize=11)
...
plt.tight_layout()
plt.savefig(OUT_DIR / "pred_dist_nb15d.png", dpi=100, bbox_inches="tight")
plt.close(); print("Saved pred_dist_nb15d.png")
