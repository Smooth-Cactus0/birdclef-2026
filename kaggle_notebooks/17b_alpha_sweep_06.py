...
auc_df.to_csv(OUT_DIR / "per_class_auc_nb17b.csv", index=False)
...
diagnostics = {
    "notebook": "nb17b", "model": "alpha-sweep-06",
...
with open(OUT_DIR / "diagnostics_nb17b.json", "w") as f:
    json.dump(diagnostics, f, indent=2)
print("Saved diagnostics_nb17b.json")
...
fig.suptitle("nb17b alpha-sweep 0.6: Prediction Distributions", fontsize=11)
...
plt.tight_layout()
plt.savefig(OUT_DIR / "pred_dist_nb17b.png", dpi=100, bbox_inches="tight")
plt.close(); print("Saved pred_dist_nb17b.png")
