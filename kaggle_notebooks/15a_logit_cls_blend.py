# %%
# ============================================================================
# BirdCLEF 2026 -- nb15a: Perch Per-Class Logit Feature + Alpha-Blend ON
# ============================================================================
...
auc_df.to_csv(OUT_DIR / "per_class_auc_nb15a.csv", index=False)
...
diagnostics = {
    "notebook": "nb15a", "model": "per-class-logit-blend-on",
    "blend": True, "logit_mode": "per_class",
...
with open(OUT_DIR / "diagnostics_nb15a.json", "w") as f:
    json.dump(diagnostics, f, indent=2)
print("Saved diagnostics_nb15a.json")
...
fig.suptitle("nb15a per-class-logit (blend ON): Prediction Distributions", fontsize=11)
...
plt.tight_layout()
plt.savefig(OUT_DIR / "pred_dist_nb15a.png", dpi=100, bbox_inches="tight")
plt.close(); print("Saved pred_dist_nb15a.png")
