...
auc_df.to_csv(OUT_DIR / "per_class_auc_nb17c.csv", index=False)
...
diagnostics = {
    "notebook": "nb17c", "model": "alpha-sweep-08",
    "blend": True, "logit_mode": "per_class", "alpha": 0.8,
...
with open(OUT_DIR / "diagnostics_nb17c.json", "w") as f:
    json.dump(diagnostics, f, indent=2)
print("Saved diagnostics_nb17c.json")
...
fig.suptitle("nb17c alpha-sweep 0.8: Prediction Distributions", fontsize=11)
...
plt.tight_layout()
plt.savefig(OUT_DIR / "pred_dist_nb17c.png", dpi=100, bbox_inches="tight")
plt.close(); print("Saved pred_dist_nb17c.png")
