...
WD         = 1e-4
BATCH_SZ   = 128
ALPHA      = 0.6     # nb17b champion blend weight
...
auc_df.to_csv(OUT_DIR / "per_class_auc_nb19a.csv", index=False)
...
diagnostics = {
    "notebook": "nb19a", "model": "topk-postproc-on-nb17b",
...
with open(OUT_DIR / "diagnostics_nb19a.json", "w") as f:
    json.dump(diagnostics, f, indent=2)
print("Saved diagnostics_nb19a.json")
...
plt.tight_layout()
plt.savefig(OUT_DIR / "pred_dist_nb19a.png", dpi=100, bbox_inches="tight")
plt.close(); print("Saved pred_dist_nb19a.png")
...
print(f"Pre-postproc: {final.shape}  min={final.min():.4f}  max={final.max():.4f}")
